...
**CISUM** 通過 Web3 提供多種挖礦機制，使用戶能夠獲得獎勵。從帳戶創建到參與、支付和質押，每項活動都以 `CISUM` 或 `STAR` 代幣形式創造價值，為藝術家和粉絲建構一個充滿活力的生態系統。

| 挖礦類型             | 描述                                                           |
|-----------------------|-------------------------------------------------------------|
| `PoH`：註冊證明      | 每個新帳戶註冊將新鑄造價值 一定金额 的 `CISUM` 代幣和 100 個 `NESTAR` 積分     |
